...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    Optional<User> findByOauthProviderAndOauthId(com.pfe.promotionplatform.entity.OAuthProvider oauthProvider, String oauthId);
    ...
    @Query("""
        ...
        where u.oauthProvider = com.pfe.promotionplatform.entity.OAuthProvider.GOOGLE
    ...
    @Query("""
        ...
        where u.oauthProvider = com.pfe.promotionplatform.entity.OAuthProvider.LOCAL
          and u.localPasswordSet is null
    """)
